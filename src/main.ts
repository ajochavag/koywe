...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    ...
    .setDescription('La API se encarga de generar cotizaciones en el mercado de cryptomonedas, permitiendo un input de tipo de divisa y monto de la misma para hacer un swap hacia otra divisa disponible')
    .setVersion('1.0')
    .addBearerAuth()
    .build();
